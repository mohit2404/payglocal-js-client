import { TYPE_OBJECT, TYPE_STRING } from "./constants.js";
import { NullError, InvalidType, EmptyError } from "./error.js";
...
const validatePrivateKey = (privateKey) => {
  ...
  if (typeof privateKey !== TYPE_STRING)
    InvalidType("Private Key", TYPE_STRING);
};
...
export const validateGenerateJWEParams = ({ payload, publicKey }) => {
  validatePayload(payload);
  validatePublicKey(publicKey);
};

export const validateGenerateJWSParams = ({ payload, privateKey }) => {
